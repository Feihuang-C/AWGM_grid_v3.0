function varargout = af_step5_pickDisp(varargin)
% AF_STEP5_PICKDISP MATLAB code for af_step5_pickDisp.fig
%      AF_STEP5_PICKDISP, by itself, creates a new AF_STEP5_PICKDISP or raises the existing
%      singleton*.
%
%      H = AF_STEP5_PICKDISP returns the handle to a new AF_STEP5_PICKDISP or the handle to
%      the existing singleton*.
%
%      AF_STEP5_PICKDISP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in AF_STEP5_PICKDISP.M with the given input arguments.
%
%      AF_STEP5_PICKDISP('Property','Value',...) creates a new AF_STEP5_PICKDISP or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before af_step5_pickDisp_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to af_step5_pickDisp_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help af_step5_pickDisp

% Last Modified by GUIDE v2.5 10-Jun-2023 20:11:35

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1; 
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @af_step5_pickDisp_OpeningFcn, ...
    'gui_OutputFcn',  @af_step5_pickDisp_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before af_step5_pickDisp is made visible.
function af_step5_pickDisp_OpeningFcn(hObject, eventdata, handles, varargin) %#ok<*INUSL>
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to af_step5_pickDisp (see VARARGIN)

% Choose default command line output for af_step5_pickDisp
...
% UIWAIT makes af_step5_pickDisp wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = af_step5_pickDisp_OutputFcn(hObject, eventdata, handles)
