...
%   $Revision: 1.11.4.3 $  $Date: 2004/10/18 21:07:40 $
...
if btype == 1		% Lowpass
	[a,b,c,d] = lp2lp0(a,b,c,d,Wn);

elseif btype == 2	% Bandpass
	[a,b,c,d] = lp2bp0(a,b,c,d,Wn,Bw);

elseif btype == 3	% Highpass
	[a,b,c,d] = lp2hp0(a,b,c,d,Wn);

elseif btype == 4	% Bandstop
	[a,b,c,d] = lp2bs0(a,b,c,d,Wn,Bw);
end

% step5: Use Bilinear transformation to find discrete equivalent:
if ~analog,
	[a,b,c,d] = bilinear0(a,b,c,d,fs);
end
