...
close all
clear rall
fsks='..\..\data\sks-database.txt'
fsks2='..\..\data\sks-database-unique.txt'
%%sks splitting time stattics
%sks_ani(fsks,fsks2)
...
%%pms splitting time stattics
pms_ani(flpms0,100)

%%pms directions:  Chen .vs. Sun
%plot_pms_vs_pms_statistics(flpms1,flpms2,200)

%%compare PMS .vs. NZ
flnz=[pthi0 'vslay_dep0000_0050_da10_ans3d_smth.dat'];
flpms0=[pthi0 'ss_pms_all.txt'];
flpms1=[pthi0 'ss_pms_chenyun_etibet.txt']
flpms2=[pthi0 'ss_pms_sunya-rf.txt']
